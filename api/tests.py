...
class ProductAPITestCase(APITestCase):
    def setUp(self):
        ...
        self.url = reverse('products-detail', kwargs={'product_id': self.product.pk})
...
class UserOrderTestCase(TestCase):
    def setUp(self):
        ...
        Order.objects.create(user=user1), Order.objects.create(user=user1)
        Order.objects.create(user=user2), Order.objects.create(user=user2)

    def test_uesr_order_endpoint_retrieves_only_authenticated_user_orders(self):
